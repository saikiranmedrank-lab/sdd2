...
export const MANUAL_GROUP_PATCH = {
  adhere: p(G.movement, "action"),
  appropriate: p(G.brain, "judgement"),
  absolute: p(G.brain, "judgement"),
  anodyne: p(G.change, "improvement"),
  amass: p(G.money, "money-growth"),
  belated: p(G.nature, "time"),
  bland: p(G.brain, "judgement"),
  ...
  infallible: p(G.brain, "judgement"),
  ...
  quintessence: p(G.brain, "judgement"),
  ...
  compatible: p(G.brain, "judgement"),
  ...
  impeccable: p(G.brain, "judgement"),
  ...
  agitate: p(G.emotion, "fear"),
  agony: p(G.emotion, "sadness"),
  altruist: p(G.social, "help"),
  apologetic: p(G.emotion, "sadness"),
  awful: p(G.emotion, "fear"),
  authentic: p(G.brain, "judgement"),
  bewitch: p(G.emotion, "desire"),
  bold: p(G.attack, "defence"),
  captivate: p(G.emotion, "desire"),
  cache: p(G.nature, "place"),
  camouflage: p(G.attack, "defence"),
  castigate: p(G.speech, "argument"),
  contentious: p(G.speech, "argument"),
  collusion: p(G.law, "crime"),
  compunction: p(G.emotion, "sadness"),
  conceit: p(G.power, "status"),
  confidant: p(G.social, "friendship"),
  congregation: p(G.social, "society"),
  conscientious: p(G.work, "effort"),
  consternation: p(G.emotion, "fear"),
  covert: p(G.social, "behaviour"),
  cynical: p(G.brain, "judgement"),
  cynosure: p(G.power, "status"),
  camaraderie: p(G.social, "friendship"),
  dazzle: p(G.emotion, "fear"),
  demure: p(G.social, "behaviour"),
  dismay: p(G.emotion, "sadness"),
  dormant: p(G.change, "decline"),
  distraught: p(G.emotion, "fear"),
  deference: p(G.power, "rank"),
  disdainful: p(G.social, "insult"),
  delectable: p(G.emotion, "joy"),
  detractors: p(G.speech, "argument"),
  duo: p(G.money, "quantity"),
  divisive: p(G.attack, "conflict"),
  dwarf: p(G.nature, "body"),
  effervescent: p(G.emotion, "joy"),
  elation: p(G.emotion, "joy"),
  elixir: p(G.change, "improvement"),
  entice: p(G.emotion, "desire"),
  euphony: p(G.speech, "speech"),
  egregious: p(G.law, "justice"),
  emissary: p(G.speech, "speech"),
  empathy: p(G.social, "help"),
  esoteric: p(G.brain, "confusion"),
  esteem: p(G.power, "status"),
  exertion: p(G.work, "effort"),
  fanatic: p(G.emotion, "desire"),
  fastidious: p(G.brain, "judgement"),
  fervent: p(G.emotion, "desire"),
  fervour: p(G.emotion, "desire"),
  flagrant: p(G.law, "justice"),
  fractious: p(G.speech, "argument"),
  fascinate: p(G.emotion, "desire"),
  fabricate: p(G.brain, "judgement"),
  fiction: p(G.speech, "writing"),
  gorgeous: p(G.emotion, "joy"),
  gullible: p(G.brain, "judgement"),
  germane: p(G.brain, "judgement"),
  giddiness: p(G.emotion, "joy"),
  hilarious: p(G.emotion, "joy"),
  hoodwink: p(G.social, "behaviour"),
  hallucination: p(G.brain, "confusion"),
  hideous: p(G.emotion, "fear"),
  harsh: p(G.attack, "violence"),
  intimidate: p(G.emotion, "fear"),
  intrigue: p(G.law, "crime"),
  impostor: p(G.law, "crime"),
  inflate: p(G.change, "increase"),
  incongruous: p(G.brain, "confusion"),
  inflict: p(G.attack, "violence"),
  jolt: p(G.movement, "motion"),
  lurid: p(G.emotion, "fear"),
  magnanimous: p(G.social, "help"),
  masochist: p(G.emotion, "desire"),
  materialistic: p(G.money, "money-growth"),
  mendicant: p(G.money, "poverty"),
  mercurial: p(G.emotion, "desire"),
  misrepresent: p(G.speech, "speech"),
  mitigate: p(G.change, "reduction"),
  moan: p(G.speech, "speech"),
  mobilise: p(G.movement, "action"),
  mock: p(G.social, "insult"),
  mortify: p(G.emotion, "sadness"),
  negligent: p(G.work, "failure"),
  nurture: p(G.social, "help"),
  oblivion: p(G.brain, "memory"),
  omnipresent: p(G.nature, "place"),
  ovation: p(G.speech, "praise"),
  pandemic: p(G.nature, "body"),
  pensive: p(G.brain, "judgement"),
  premonition: p(G.brain, "judgement"),
  punitive: p(G.law, "punishment"),
  palliate: p(G.change, "improvement"),
  prodigy: p(G.brain, "sharp-mind"),
  propensity: p(G.emotion, "desire"),
  prosaic: p(G.brain, "judgement"),
  priority: p(G.power, "status"),
  predators: p(G.attack, "attack"),
  raucous: p(G.speech, "speech"),
  reproach: p(G.speech, "argument"),
  resurgent: p(G.change, "increase"),
  revere: p(G.power, "status"),
  salubrious: p(G.nature, "body"),
  spry: p(G.movement, "speed"),
  suffuse: p(G.movement, "motion"),
  shapeless: p(G.nature, "object"),
  seclude: p(G.social, "society"),
  tantamount: p(G.brain, "judgement"),
  "tete-a-tete": p(G.speech, "speech"),
  telltale: p(G.speech, "speech"),
  torment: p(G.emotion, "sadness"),
  tranquility: p(G.emotion, "calm"),
  tribute: p(G.speech, "praise"),
  tyrant: p(G.power, "leadership"),
  trivial: p(G.brain, "judgement"),
  unworthy: p(G.brain, "judgement"),
  vagaries: p(G.change, "difference"),
  veteran: p(G.work, "skill"),
  "volte-face": p(G.change, "change"),
  wretch: p(G.emotion, "sadness"),
  nostrum: p(G.change, "improvement"),
  numbness: p(G.nature, "body"),
  aloof: p(G.social, "behaviour"),
  apathetic: p(G.emotion, "sadness"),
  accustomed: p(G.brain, "judgement"),
  bankrupt: p(G.money, "poverty"),
  downcast: p(G.emotion, "sadness"),
  exultant: p(G.emotion, "joy"),
  gaunt: p(G.nature, "body"),
  glum: p(G.emotion, "sadness"),
  grumble: p(G.speech, "argument"),
  hassle: p(G.emotion, "anger"),
  inherent: p(G.nature, "nature"),
  jeer: p(G.social, "insult"),
  jinx: p(G.emotion, "fear"),
  levity: p(G.social, "behaviour"),
  meddle: p(G.social, "behaviour"),
  mendacious: p(G.social, "behaviour"),
  mollycoddle: p(G.social, "help"),
  noble: p(G.social, "behaviour"),
  olfactory: p(G.nature, "body"),
  parsimonious: p(G.money, "scarcity"),
  patrimony: p(G.money, "value"),
  penitent: p(G.emotion, "sadness"),
  posterity: p(G.social, "family"),
  propitious: p(G.work, "success"),
  proactive: p(G.work, "effort"),
  rapturous: p(G.emotion, "joy"),
  sanguine: p(G.emotion, "joy"),
  scintillating: p(G.emotion, "joy"),
  solace: p(G.emotion, "calm"),
  solicitous: p(G.social, "help"),
  sprightly: p(G.emotion, "joy"),
  suave: p(G.social, "behaviour"),
  stale: p(G.nature, "object"),
  stunning: p(G.emotion, "joy"),
  tactile: p(G.nature, "body"),
  trifling: p(G.brain, "judgement"),
  threaten: p(G.attack, "attack"),
  travesty: p(G.change, "difference"),
  vanity: p(G.power, "status"),
  vice: p(G.law, "crime"),
  "vis-a-vis": p(G.brain, "judgement"),
  vivacious: p(G.emotion, "joy"),
  waggish: p(G.emotion, "joy"),
  wry: p(G.emotion, "joy"),
  mesmerize: p(G.emotion, "desire"),
  nuptial: p(G.social, "family"),
  exclusion: p(G.social, "society"),
  firmly: p(G.nature, "object"),
};
